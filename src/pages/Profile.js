            ...
            <div className="mt-8 flex flex-col space-y-3">
              ...
              >
                <svg className="-ml-1 mr-2 h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M3 3a1 1 0 00-1 1v12a1 1 0 001 1h12a1 1 0 001-1V7.414l-5-5H3zm7 5a1 1 0 100 2h1a1 1 0 100-2h-1z" clipRule="evenodd" />
              ...
              <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                ...
                <div className="relative flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    <label htmlFor="isDroneOperator" className="font-medium text-gray-700">
                      I am a drone operator
                    </label>
                    <p className="text-gray-500">Register as a drone operator to help respond to emergencies.</p>
                  </div>
                </div>
                    ...
                    <div className="mt-4">
                      <div className="flex space-x-3">
                        <button
                          ...
                          className={`inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md shadow-sm text-white ${
                            locationLoading ? 'bg-gray-400' : 'bg-blue-600 hover:bg-blue-700'
                      ...
                      {!showManualLocation && formData.location && (
                        <div className="mt-3 bg-white p-3 rounded-md border border-gray-200">
                          ...
                          <p className="text-sm">Lat: {formData.location.latitude.toFixed(6)}</p>
                          <p className="text-sm">Lng: {formData.location.longitude.toFixed(6)}</p>
                        </div>
                      )}
                      
                      {showManualLocation && (
                        <div className="mt-3 bg-white p-4 rounded-md border border-gray-200">
                          <h3 className="font-medium mb-2 text-sm">Enter Location Manually</h3>
